"""Run MS-Dialog flexible-turn experiment — Gemma 3-12B specialist + Gemini simulator.
...
Usage:
    python run_msdialog_gemma_flex.py
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(ROOT / "logs" / "msdialog_gemma_flex.log", encoding="utf-8"),
    ],
)
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("MS-Dialog Gemma Flex Experiment (optional CQs, 0–3 turns)")
