"""Generate medqa_analysis_gemma-3-12b-it.ipynb — model-specific analysis notebook."""
import json, uuid, pathlib

ROOT = pathlib.Path(__file__).parent
NOTEBOOK_NAME = "medqa_analysis_gemma-3-12b-it.ipynb"
...
## Model: `gemma-3-12b-it` | Dataset: MedQA
