"""Run MS-Dialog Phase 1 single-turn experiment — Gemma 3-12B specialist + Gemini simulator.
...
Usage:
    python run_msdialog_gemma_singleturn.py
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(ROOT / "logs" / "msdialog_gemma_singleturn.log", encoding="utf-8"),
    ],
)
...
def main() -> None:
    ...
    from src.pipeline import MsDialogPhase1Pipeline
    ...
    logger.info("=" * 70)
    logger.info("MS-Dialog Gemma Single-Turn Experiment")
